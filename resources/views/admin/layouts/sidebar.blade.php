...
@endphp
 <div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <!-- Light Logo-->
        <a href="index.html" class="logo text-light logo-light">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                {{--<li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">Services</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="apps-calendar.html" class="nav-link" data-key="t-calendar"> Add New Service  </a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">Service Category</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link @if (Route::currentRouteName() === 'admin.business_settings') collapse active  @endif" href="#sidebarsetting" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-apps">SETTINGS</span>
                    </a>
                    <div class="collapse menu-dropdown @if (Route::currentRouteName() === 'admin.business_settings') show  @endif" id="sidebarsetting">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('admin.business_settings')}}" class="nav-link @if (Route::currentRouteName() === 'admin.business_settings') active @endif" data-key="t-calendar"> Business Settings   </a>
                            </li>
                ...
                {{--<li class="nav-item">
                    <a class="nav-link menu-link " href="#sidebarsetting" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="mdi mdi-animation-outline"></i> <span data-key="t-apps">SLIDER </span>
                    </a>
                    <div class="collapse menu-dropdown @if (Route::currentRouteName() === 'admin.slider') show  @endif" id="sidebarsetting">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('admin.slider')}}" class="nav-link @if (Route::currentRouteName() === 'admin.slider') active @endif" data-key="t-calendar"> All Slider   </a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                        <i class="mdi mdi-account-circle-outline"></i> <span data-key="t-authentication">System Features </span>
                    </a>
                    <div class="collapse menu-dropdown show" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            {{--<li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#sidebarSignUp" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignUp" data-key="t-signup"> Slider 
                                </a>
                                <div class="collapse menu-dropdown @if (Route::currentRouteName() === 'admin.slider') show  @endif" id="sidebarSignUp">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('admin.slider')}}"  class="nav-link @if (Route::currentRouteName() === 'admin.slider') active  @endif" data-key="t-basic"> All Slider  </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            {{--<li class="nav-item">
                                <a href="#sidebarResetPass" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarResetPass" data-key="t-password-reset">After Slider Content 
                                </a>
                                <div class="collapse menu-dropdown @if (Route::currentRouteName() === 'admin.afterSlider') show  @endif" id="sidebarResetPass">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('admin.afterSlider')}}" class="nav-link @if (Route::currentRouteName() === 'admin.afterSlider') active @endif" data-key="t-basic"> All Slider Content  </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>--}}
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown  @if (Route::currentRouteName() === 'admin.globalUrl') show  @endif" id="sidebarchangePass">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('admin.globalUrl.show')}}" class="nav-link @if (Route::currentRouteName() === 'admin.globalUrl') active @endif" data-key="t-basic">
                                                All Global Url </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarLockScreen1" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLockScreen1" data-key="t-lock-screen"> Service Categories  
                                </a> 
                                <div class="collapse menu-dropdown" id="sidebarLockScreen1">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('serviceCategory.index')}}" class="nav-link @if (Route::currentRouteName() === 'serviceCategory.index') active @endif" data-key="t-basic"> All Categories  </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('serviceCategory.create')}}" class="nav-link  @if (Route::currentRouteName() === 'serviceCategory.create') active @endif" data-key="t-cover"> Create Category  </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarLogout" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLogout" data-key="t-logout"> Service 
                                </a>
                                <div class="collapse menu-dropdown  {{ (Request::is('admin/service/create') || Request::is('admin/service')) ? 'show' : '' }}" id="sidebarLogout">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('service.index')}}" class="nav-link @if (Route::currentRouteName() === 'service.index') active @endif" data-key="t-basic"> All Service  </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('service.create')}}" class="nav-link @if (Route::currentRouteName() === 'service.create') active @endif" data-key="t-cover"> Create Service  </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarSuccessMsg" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSuccessMsg" data-key="t-success-message"> Blogs  
                                </a>
                                <div class="collapse menu-dropdown {{ (Request::is('admin/blog/create') || Request::is('admin/blog')) ? 'show' : '' }}" id="sidebarSuccessMsg">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('blog.index')}}" class="nav-link @if (Route::currentRouteName() === 'blog.index') active @endif" data-key="t-basic"> All Blogs  </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('blog.create')}}" class="nav-link @if (Route::currentRouteName() === 'blog.create') active @endif" data-key="t-cover"> Create Blog </a>
                                        </li>
                                        {{-- <li class="nav-item">
                                            <a href="{{route('blog.edit')}}" class="nav-link @if (Route::currentRouteName() === 'blog.edit') active @endif" data-key="t-cover"> Edit Blog </a>
                                        </li> --}}
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a href="#sidebarLogout" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLogout" data-key="t-logout"> Menu 
                                </a>
                                <div class="collapse menu-dropdown  {{ (Request::is('admin/menu/create') || Request::is('admin/menu')) ? 'show' : '' }}" id="sidebarLogout">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('menu.index')}}" class="nav-link @if (Route::currentRouteName() === 'menu.index') active @endif" data-key="t-basic"> All Menu  </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('menu.create')}}" class="nav-link @if (Route::currentRouteName() === 'menu.create') active @endif" data-key="t-cover"> Create Menu  </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a href="#sidebarTwoStep" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTwoStep" data-key="t-two-step-verification"> Testimonial 
                                </a>
                                <div class="collapse menu-dropdown" >
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('testimonial.index')}}" class="nav-link" data-key="t-basic"> Testimonial List  </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{route('testimonial.create')}}" class="nav-link" data-key="t-cover"> Create Testimonial  </a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
...
{{--
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown {{ request()->is('menu*') ? 'show' : '' }}" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{route('menu.index')}}" class="nav-link " data-key="t-starter"> All Menus  </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('menu.create')}}" class="nav-link" data-key="t-team"> Create Menu  </a>
                            </li>
                            <li class="nav-item">
