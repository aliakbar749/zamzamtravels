...
<div class="row  mb-2 ">
        ...
        <div class="row">
            <form id="createproduct-form" method="post"  action="{{route('blog.store')}}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate="">
                @csrf
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="ckeditor-classic" name="descriptions"  id="exampleFormControlTextarea5" rows="3"></textarea>
