                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach ($blogs as $data) 
                                    <tr>
                                        ...
                                        <td>
                                            {{--<table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @php
                                                        $i=1;
                                                        $sub_categories = App\Models\Service_Category::where('category_id', $data->id)->get();
                                                    @endphp
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form method="POST" action="{{ route('serviceCategory.edit', $data->id) }}">
                                                                @csrf
                                                                <input name="_method" type="hidden" value="DELETE">
                                                                <a href="{{ route('serviceCategory.edit', $data->id) }}" onclick="editSlider({{ $data->id }})"><i class="ri-edit-fill" style="font-size: 18px;"></i></a> 
                                        ...
                                        <td>
                                            <form method="POST" action="{{ route('blog.edit', $data->id) }}">
                                                @csrf
                                                <input name="_method" type="hidden" value="DELETE">
                                                <a href="{{ route('blog.edit', $data->id) }}" onclick="editSlider({{ $data->id }})"><i class="ri-edit-fill" style="font-size: 18px;"></i></a> 
                                                <a href="{{route('blog.destroy', $data->id)}}" class="show_confirm"><i class="ri-delete-bin-fill" style="font-size: 18px;margin-left: 10px;"></i></a>
