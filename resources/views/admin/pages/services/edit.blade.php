...
<div class="row  mb-2 ">
        ...
        <div class="row">
            <form id="createproduct-form" method="post"  action="{{route('service.update', $service->id)}}" enctype="multipart/form-data" autocomplete="off" class="needs-validation" novalidate="">
                @csrf
                @method('PUT')
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="title" value="{{$service->title}}" class="form-control" id="title-input" placeholder="Enter Tttle Here ">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-name-input">Sub Title</label>
                                                <input type="text" name="subtitle" value="{{$service->subtitle}}" class="form-control" id="manufacturer-name-input" placeholder="Enter Tttle Here ">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="url" value="{{$service->url}}" class="form-control" id="url-input" id="manufacturer-name-input" placeholder="Enter URL Here  ">
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="serial" value="{{$service->serial}}" class="form-control" id="manufacturer-brand-input" placeholder="Enter Email Here ">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="ckeditor-classic" id="package-overview-editor" name="package_overview" value="{{$service->package_overview}}" placeholder="{{$service->package_overview}}"></textarea>
                                            </div> 
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="ckeditor-classic" id="itinery-editor" name="itinerary" value="{{$service->itinerary}}"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="ckeditor-classic" id="notes-policy-editor" name="notes_and_policy" value="{{$service->notes_and_policy}}" placeholder="{{$service->notes_and_policy}}"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="package-pricing-editor" class="ckeditor-classic" name="package_pricing" value="{{$service->package_pricing}}" placeholder="{{$service->package_pricing}}"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="short-description-editor" class="ckeditor-classic" name="short_description" value="{{$service->short_description}}" placeholder="{{$service->short_description}}"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea id="long-description-editor" class="ckeditor-classic" name="long_description" value="{{$service->long_description}}" placeholder="{{$service->long_description}}"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="you_tube_link" value="{{$service->video_link}}" class="form-control" id="manufacturer-name-input" placeholder="Enter You Tube Link  ">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-brand-input">Start Price </label>
                                                <input type="number" name="start_price" value="{{$service->start_price}}" class="form-control" id="manufacturer-brand-input" placeholder="Enter Start Price ">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end row -->
                                ...
                                <div class="tab-pane" id="addproduct-metadata" role="tabpanel">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="meta_title" value="{{$service->meta_title}}" class="form-control" placeholder="Enter meta title" id="meta-title-input">
                                            </div>
                                        </div>
                                        <!-- end col -->
                                        ...
                                        <div class="col-lg-4" data-select2-id="select2-data-64-jjpy">
                                            ...
                                            <input type="text" name="meta_keywords"   value="{{$service->meta_keywords}}" class="form-control" placeholder="Enter meta keywords" id="meta-keywords-input">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4" data-select2-id="select2-data-64-jjpy">
                                            ...
                                            <input type="text" name="meta_tags"  value="{{$service->meta_tags}}" class="form-control" placeholder="Enter meta tags" id="meta-tag-input">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control" name="meta_description" value="{{$service->meta_description}}" id="meta-description-input" placeholder="Enter meta description" rows="3"></textarea>
                                    </div>
                                </div>
                                <!-- end tab pane -->
                            </div>
