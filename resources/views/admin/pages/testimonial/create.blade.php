                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="addproduct-general-info" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-name-input">Name </label>
                                                <input type="text" class="form-control" id="manufacturer-name-input" placeholder="Enter Name Here ">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-name-input">User ID  </label>
                                                <input type="text" class="form-control" id="manufacturer-name-input" placeholder="Enter Name Here ">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-name-input">Email  </label>
                                                <input type="mail" class="form-control" id="manufacturer-name-input" placeholder="Enter Your Mail  ">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-brand-input">Phone  </label>
                                                <input type="phone" class="form-control" id="manufacturer-brand-input" placeholder="Enter Phone Number ">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-name-input">Serial  </label>
                                                <input type="number" class="form-control" id="manufacturer-name-input" placeholder="Enter Testimonial Serial  ">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="manufacturer-brand-input">Rating Star   </label>
                                                <input type="number" class="form-control" id="manufacturer-brand-input" placeholder="Enter Rating Star">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <label for="genderInput" class="form-label">Is Approved </label>
                                            <div>
