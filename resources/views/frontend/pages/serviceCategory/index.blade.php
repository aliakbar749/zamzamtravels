    ...
    <div class="container">
        <div class="row align-items-center text-center">
            <div class="col-md-12 col-12">
                <h2 class="breadcrumb-title">{{$title->title}}</h2>
...
<div class="breadcrumb-bar" style=" background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('uploaded_files/service_categories/'.$title->breadcrumb_image) }}');background-size: cover;">
    <div class="container">
        <div class="row align-items-center text-center">
            <div class="col-md-12 col-12">
                <h2 class="breadcrumb-title"> {{optional($title)->title}} </h2>
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page"> {{optional($title)->title}} </li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="blog grid-blog">
                                <div class="blog-image">
                                    <a href="blog-details.html"><img class="img-fluid"
                                            src="{{asset('uploaded_files/service_categories/'.$subCategory->image)}}" alt="Post Image"></a>
                                </div>
                                <div class="blog-content">
                                    <p class="blog-category">
                                        {{-- <a href="javascript:void(0)"><span>Car Showcase</span></a> --}}
                                    </p>
                                    <h3 class="blog-title"><a href="blog-details.html">{{$subCategory->title}}</a></h3>
                                    <p class="blog-description"></p>
                                    <ul class="meta-item">
                                        <li>
                                            <div class="post-author">
                                                
                                                {{ Str::limit(strip_tags($subCategory->short_description), 250) }}
                                            </div>
                                        </li>
                                      
                                    </ul>
                                    <a href="{{route('dynamic.url', $subCategory->url)}}" class="viewlink btn btn-primary">Read More <i
